...
// Project related.
var project                 = 'seasaltpress'; // Project Name.
var projectURL              = 'seasaltpress.dev'; // Project URL. Could be something like localhost:8888.
var productURL              = './'; // Theme/Plugin URL. Leave it like it is, since our gulpfile.js lives in the root folder.

// Translation related.
var text_domain             = 'seasaltpress'; // Your textdomain here.
var destFile                = 'seasaltpress.pot'; // Name of the transalation file.
var packageName             = 'seasaltpress'; // Package name.
var bugReport               = 'https://seasaltpress.com/contact/'; // Where can users report bugs.
var lastTranslator          = 'seasaltpress <your_email@email.com>'; // Last translator Email ID.
var team                    = 'seasaltpress <your_email@email.com>'; // Team's Email ID.
...
// JS Vendor related.
var jsVendorSRC             = './assets/vendor/js/*.js'; // Path to JS vendor folder.
...
var jsNotCustomSRC              = ['./assets/js/*.js', '!./assets/js/*custom.js']; //admin js files for back end
...
gulp.task( 'notCustomJS', function() {
  ...
  */
 gulp.task( 'default', ['styles', 'customJS', 'notCustomJS', 'images', 'translate'], function () {
  //gulp.watch( projectPHPWatchFiles, reload ); // Reload on PHP file changes.
  gulp.watch( styleWatchFiles, [ 'styles' ] ); // Reload on SCSS file changes.
  //gulp.watch( vendorJSWatchFiles, [ 'vendorsJs', reload ] ); // Reload on vendorsJs file changes.
  gulp.watch( customJSWatchFiles, [ 'customJS', 'notCustomJS' ] ); // Reload on customJS file changes.
