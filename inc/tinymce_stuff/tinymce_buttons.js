          ...
          menu: [
	          {
		          ...
		          menu: [
		              ...
		              text: 'Add Columns',
		              value: 'cols',
		              onclick: function(){ seasaltpressAddColumns(ed); }
		             },
		             {
			             text: 'Customize Column',
			             value: 'custom-cols',
			             onclick: function(){ seasaltpressCustomColumns(ed); }
		             },
		             {
			            text: 'Delete Columns',
			            value: 'deleteCol',
			            onclick: function(){ seasaltpressDeleteColumns(ed); }
		             },
		             {
			            text: 'Content Column',
			            value: 'contentCol',
			            onclick: function(){ seasaltpressContentColumn(ed);     }
		             }
		          ]
	          ...
	          },
	          {
	             text: 'Button',
	             value: 'button',
	             onclick: function(){ seasaltpressButton( ed); }
             },
             {
	             text: 'Exit Element',
	             value: 'exitColumns',
	              onclick: function(){ seasaltpressExitColumns(ed); }
             },
             
             {
	             text: 'Break Out',
	             value: 'breakout',
	              onclick: function(){ seasaltpressBreakout(ed); }
             },
             {
	             text: 'Wrap',
	             value: 'wrap',
	             onclick: function(){ seasaltpressWrap( ed); }
             },
 ...
 //customize column
  ...
  function seasaltpressDeleteColumns(ed){
	...
	function seasaltpressWrap( ed ){
  	...
  	var selected_text = ed.selection.getContent() ? ed.selection.getContent()  : '<p>Put content here</p>';
  	var return_text = '<div class="content-column">' + selected_text + '</div>';
  	ed.insertContent(return_text);
