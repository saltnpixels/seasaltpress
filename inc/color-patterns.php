 ...
 */
function seasaltpress_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter Sea Salt Press default saturation level.
	 *
	 * @since Sea Salt Press 1.0
	 *
	 * @param $saturation integer
	 */
	$saturation = absint( apply_filters( 'seasaltpress_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.seasaltpress-front-page) .entry-title,
...
.colors-custom .seasaltpress-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.seasaltpress-front-page .panel-content .recent-posts article,
...
.colors-custom.seasaltpress-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters Sea Salt Press custom colors CSS.
	 *
	 * @since Sea Salt Press 1.0
	 *
	 ...
	 */
	return apply_filters( 'seasaltpress_custom_colors_css', $css, $hue, $saturation );
}
